...
| `dosido-score` | Score pairs via Claude Batch API (resumable; `--force` to rescore all) |
...
dosido-score                             # Score new pairs via LLM (~1,770 pairs, ~5 min, ~$1-2; --force to rescore all)
