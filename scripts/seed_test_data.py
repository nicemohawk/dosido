...
from app.models import COMMITMENT_TIER, Commitment
...
PEOPLE = [
    ...
    {"name": "Peter R.", "role": "engineering", "role_needed": "gtm", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "debate",
     "hardest_thing": "Scaled Segment to a $3.2B acquisition while shipping product weekly.",
    ...
    {"name": "Leah E.", "role": "science", "role_needed": "gtm", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Took an electrochemical cement process from lab bench to pilot plant.",
    ...
    {"name": "Tim L.", "role": "engineering", "role_needed": "ops", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Drilled the first commercial horizontal geothermal well.",
    ...
    {"name": "Mateo J.", "role": "engineering", "role_needed": "science", "lane": "idea",
     "climate_areas": ["energy", "grid infrastructure"], "top_climate_area": "energy",
     "commitment": "full-time", "arrangement": "colocated", "location": "Boston",
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "debate",
     "hardest_thing": "Led Tesla's grid storage division through 10x growth.",
    ...
    {"name": "Jigar S.", "role": "gtm", "role_needed": "engineering", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Ran a $400B federal loan office without losing taxpayer money.",
    ...
    {"name": "Lynn J.", "role": "gtm", "role_needed": "engineering", "lane": "idea",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "SF",
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Took Sunrun from two founders to a $4B public company.",
    ...
    {"name": "Danielle F.", "role": "science", "role_needed": "ops", "lane": "idea",
     ...
     "commitment": "full-time-soon", "arrangement": "remote-open", "location": "SF",
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "equal",
     "idea_flexibility": "flexible", "edge": "technical", "decision_style": "debate",
     "hardest_thing": "Built compressed air energy storage prototypes at 22.",
    ...
    {"name": "Kiran B.", "role": "product", "role_needed": "engineering", "lane": "idea",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "NYC",
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Grew Arcadia into the largest community solar platform in the US.",
    ...
    {"name": "Danny K.", "role": "gtm", "role_needed": "product", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "moderate", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "flexible", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Built clean energy incubators across ten countries.",
    ...
    {"name": "Etosha C.", "role": "science", "role_needed": "gtm", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Turned captured CO2 into jet fuel at pilot scale.",
    ...
    {"name": "Priyanka B.", "role": "engineering", "role_needed": "gtm", "lane": "idea",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "SF",
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "write-then-decide",
     "hardest_thing": "Commissioned two chemical recycling plants from greenfield.",
    ...
    {"name": "Cathy Z.", "role": "ops", "role_needed": "engineering", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Scaled the largest US fast-charging network while wrangling federal grants.",
    ...
    {"name": "Alex L.", "role": "product", "role_needed": "engineering", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Co-founded Opower and drove it to an Oracle acquisition.",
    ...
    {"name": "Ryan O.", "role": "product", "role_needed": "engineering", "lane": "joiner",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "SF",
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "write-then-decide",
     "hardest_thing": "Shipped Watershed's carbon accounting platform to Fortune 500 customers.",
    ...
    {"name": "Nan R.", "role": "ops", "role_needed": "science", "lane": "flexible",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "SF",
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Stood up Frontier's $1B carbon removal commitment from scratch.",
    ...
    {"name": "Patrick B.", "role": "science", "role_needed": "ops", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "debate",
     "hardest_thing": "Turned a Stanford lab discovery into a global meat brand.",
    ...
    {"name": "Saul G.", "role": "engineering", "role_needed": "policy", "lane": "idea",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "SF",
     "runway": "3-12-months", "ambition": "moderate", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "debate",
     "hardest_thing": "Wrote the household electrification handbook while running a nonprofit.",
    ...
    {"name": "Tom S.", "role": "gtm", "role_needed": "science", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Built a hedge fund, then walked away to organize on climate.",
    ...
    {"name": "Gia S.", "role": "engineering", "role_needed": "gtm", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Designed fish-safe turbines that survived federal field trials.",
    ...
    {"name": "Chris S.", "role": "gtm", "role_needed": "engineering", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Raised $800M for climate after two decades of angel bets.",
    ...
    {"name": "John D.", "role": "gtm", "role_needed": "science", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Backed Google and Amazon before either had revenue.",
    ...
    {"name": "Vinod K.", "role": "engineering", "role_needed": "science", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "flexible", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Co-founded Sun Microsystems and bet billions on moonshots.",
    ...
    {"name": "Nancy P.", "role": "gtm", "role_needed": "science", "lane": "flexible",
     ...
     "commitment": "exploring", "arrangement": "remote-open", "location": "SF",
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "data-driven",
     "hardest_thing": "Proved climate investing returns with early Tesla and SolarCity bets.",
    ...
    {"name": "Carmichael R.", "role": "science", "role_needed": "engineering", "lane": "flexible",
     ...
     "commitment": "full-time-soon", "arrangement": "remote-open", "location": "Boston",
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Vetted hundreds of hard-tech deals as a materials scientist.",
    ...
    {"name": "Emily K.", "role": "gtm", "role_needed": "engineering", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Built Powerhouse from a coworking space into a venture platform.",
    ...
    {"name": "Shayle K.", "role": "gtm", "role_needed": "science", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Turned energy market analysis into a top climate podcast and a fund seat.",
    ...
    {"name": "Dawn L.", "role": "ops", "role_needed": "engineering", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Scaled Elemental Excelerator across 100+ portfolio deployments.",
    ...
    {"name": "Bill G.", "role": "science", "role_needed": "engineering", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "flexible", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Built Microsoft, then the largest private climate fund.",
    ...
    {"name": "Laurene P.", "role": "policy", "role_needed": "science", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Built Emerson Collective into a multi-billion-dollar impact platform.",
    ...
    {"name": "Jeff B.", "role": "ops", "role_needed": "science", "lane": "idea",
     ...
     "commitment": "exploring", "arrangement": "remote-open", "location": "Seattle",
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "flexible", "edge": "network", "decision_style": "data-driven",
     "hardest_thing": "Built Amazon from a garage; now deploying a $10B Earth Fund.",
    ...
    {"name": "Marc B.", "role": "product", "role_needed": "ops", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "equal",
     "idea_flexibility": "flexible", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Grew Salesforce from an apartment startup to a global platform.",
    ...
    {"name": "Michael B.", "role": "policy", "role_needed": "engineering", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "data-driven",
     "hardest_thing": "Helped retire half the US coal fleet through Beyond Coal.",
    ...
    {"name": "Ramez N.", "role": "science", "role_needed": "product", "lane": "flexible",
     ...
     "commitment": "part-time", "arrangement": "remote-open", "location": "Seattle",
     "runway": "3-12-months", "ambition": "moderate", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "write-then-decide",
     "hardest_thing": "Wrote the definitive clean energy cost curve analyses.",
    ...
    {"name": "Arun M.", "role": "science", "role_needed": "engineering", "lane": "flexible",
     ...
     "commitment": "exploring", "arrangement": "remote-open", "location": "SF",
     "runway": "12-plus-months", "ambition": "undecided", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "debate",
     "hardest_thing": "Founded ARPA-E and stood it up inside a federal bureaucracy.",
    ...
    {"name": "Julio F.", "role": "science", "role_needed": "gtm", "lane": "flexible",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "NYC",
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "contribution-based",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "write-then-decide",
     "hardest_thing": "Built Carbon Direct into the leading carbon management advisor.",
    ...
    {"name": "Jason J.", "role": "gtm", "role_needed": "product", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Grew a podcast into climate tech's connective community and a fund.",
    ...
    {"name": "Katherine H.", "role": "policy", "role_needed": "engineering", "lane": "flexible",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "NYC",
     "runway": "3-12-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "write-then-decide",
     "hardest_thing": "Steered grid interconnection reform through FERC.",
    ...
    {"name": "Jesse J.", "role": "science", "role_needed": "policy", "lane": "flexible",
     ...
     "commitment": "exploring", "arrangement": "remote-open", "location": "NYC",
     "runway": "3-12-months", "ambition": "undecided", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Built the REPEAT model tracking US decarbonization in real time.",
    ...
    {"name": "Jessika T.", "role": "science", "role_needed": "product", "lane": "flexible",
     ...
     "commitment": "part-time", "arrangement": "remote-open", "location": "Boston",
     "runway": "3-12-months", "ambition": "undecided", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Quantified the learning curves behind solar's 99% cost decline.",
    ...
    {"name": "Audrey Z.", "role": "ops", "role_needed": "engineering", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Ran Australia's grid operator through an energy transition.",
    ...
    {"name": "Sunil P.", "role": "product", "role_needed": "engineering", "lane": "idea",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "SF",
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "domain", "decision_style": "debate",
     "hardest_thing": "Founded three companies across health and transportation.",
    ...
    {"name": "Bruce U.", "role": "gtm", "role_needed": "science", "lane": "flexible",
     ...
     "commitment": "part-time", "arrangement": "remote-open", "location": "NYC",
     "runway": "12-plus-months", "ambition": "undecided", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "write-then-decide",
     "hardest_thing": "Turned climate finance into a flagship MBA curriculum.",
    ...
    {"name": "Nat K.", "role": "gtm", "role_needed": "engineering", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Built the financing rails behind residential solar's boom.",
    ...
    {"name": "Will W.", "role": "product", "role_needed": "engineering", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "domain", "decision_style": "debate",
     "hardest_thing": "Bootstrapped Palmetto's first thousand solar installs.",
    ...
    {"name": "David B.", "role": "engineering", "role_needed": "gtm", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Led SunPower's cell efficiency engineering for two decades.",
    ...
    {"name": "Mike B.", "role": "engineering", "role_needed": "gtm", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "contribution-based",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "write-then-decide",
     "hardest_thing": "Proved mixed-plastics recycling works at industrial scale.",
    ...
    {"name": "Ellen W.", "role": "science", "role_needed": "ops", "lane": "flexible",
     ...
     "runway": "12-plus-months", "ambition": "undecided", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "debate",
     "hardest_thing": "Directed ARPA-E's breakthrough energy research portfolio.",
    ...
    {"name": "Abe G.", "role": "product", "role_needed": "engineering", "lane": "idea",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "SF",
     "runway": "under-3-months", "ambition": "venture-scale", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Built a soil carbon measurement pipeline on a shoestring.",
    ...
    {"name": "Lisa D.", "role": "engineering", "role_needed": "gtm", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Designed floating wind platforms that survived tank testing.",
    ...
    {"name": "Carlos M.", "role": "engineering", "role_needed": "ops", "lane": "idea",
     ...
     "runway": "under-3-months", "ambition": "venture-scale", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "debate",
     "hardest_thing": "Built a working electrolyzer prototype in a garage lab.",
    ...
    {"name": "Sarah C.", "role": "policy", "role_needed": "product", "lane": "flexible",
     ...
     "runway": "3-12-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "write-then-decide",
     "hardest_thing": "Negotiated climate provisions inside the White House.",
    ...
    {"name": "Maya T.", "role": "science", "role_needed": "engineering", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Ran multi-season field trials of nitrogen-fixing microbes.",
    ...
    {"name": "Kevin C.", "role": "engineering", "role_needed": "product", "lane": "joiner",
     ...
     "commitment": "full-time", "arrangement": "colocated", "location": "NYC",
     "runway": "3-12-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "technical", "decision_style": "write-then-decide",
     "hardest_thing": "Retrofitted hundred-year-old buildings with modern heat pumps.",
    ...
    {"name": "Rachel K.", "role": "gtm", "role_needed": "engineering", "lane": "idea",
     ...
     "runway": "under-3-months", "ambition": "venture-scale", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Signed her first twenty restaurant partners before the product existed.",
    ...
    {"name": "Derek W.", "role": "engineering", "role_needed": "science", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Ran an open-ocean carbon removal pilot under full MRV scrutiny.",
    ...
    {"name": "Tina H.", "role": "ops", "role_needed": "engineering", "lane": "joiner",
     ...
     "runway": "12-plus-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "write-then-decide",
     "hardest_thing": "Scaled EV charging operations from 100 to 10,000 stations.",
    ...
    {"name": "Omar F.", "role": "science", "role_needed": "gtm", "lane": "idea",
     ...
     "commitment": "full-time-soon", "arrangement": "colocated", "location": "Boston",
     "runway": "under-3-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Pushed perovskite tandem cells past efficiency records at MIT.",
    ...
    {"name": "Nina P.", "role": "product", "role_needed": "science", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Cut farm water use 40% in her first pilot season.",
    ...
    {"name": "James L.", "role": "engineering", "role_needed": "ops", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "debate",
     "hardest_thing": "Automated interconnection studies utilities had done by hand for decades.",
    ...
    {"name": "Fatima A.", "role": "science", "role_needed": "product", "lane": "idea",
     ...
     "commitment": "full-time-soon", "arrangement": "colocated", "location": "Chicago",
     "runway": "under-3-months", "ambition": "venture-scale", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "technical", "decision_style": "data-driven",
     "hardest_thing": "Doubled electrolyzer catalyst efficiency in her lab.",
    ...
    {"name": "Raj V.", "role": "product", "role_needed": "engineering", "lane": "joiner",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "n/a", "edge": "domain", "decision_style": "data-driven",
     "hardest_thing": "Built carbon market tooling inside Goldman's risk machine.",
    ...
    {"name": "Albert E.", "role": "science", "role_needed": "engineering", "lane": "idea",
     "climate_areas": ["energy", "hydrogen", "grid infrastructure"], "top_climate_area": "energy",
     "commitment": "exploring", "arrangement": "remote-open", "location": "Boston",
     "runway": "undisclosed", "ambition": "undecided", "equity_philosophy": "no-strong-view",
     "idea_flexibility": "flexible", "edge": "domain", "decision_style": "debate",
     "hardest_thing": "Reinvented physics from a patent office desk.",
    ...
    {"name": "Jimmy C.", "role": "policy", "role_needed": "engineering", "lane": "idea",
     ...
     "commitment": "full-time", "arrangement": "remote-open", "location": "Austin",
     "runway": "3-12-months", "ambition": "bootstrap", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "write-then-decide",
     "hardest_thing": "Ran a country, then built houses by hand for decades.",
    ...
    {"name": "Rachel C.", "role": "science", "role_needed": "gtm", "lane": "idea",
     ...
     "commitment": "full-time", "arrangement": "remote-open", "location": "Boston",
     "runway": "under-3-months", "ambition": "moderate", "equity_philosophy": "equal",
     "idea_flexibility": "committed", "edge": "domain", "decision_style": "write-then-decide",
     "hardest_thing": "Wrote the book that launched the environmental movement while seriously ill.",
    ...
    {"name": "Al G.", "role": "gtm", "role_needed": "science", "lane": "idea",
     ...
     "runway": "12-plus-months", "ambition": "venture-scale", "equity_philosophy": "contribution-based",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Turned a slideshow into a global climate movement and an Oscar.",
    ...
    {"name": "Jay I.", "role": "policy", "role_needed": "product", "lane": "idea",
     ...
     "runway": "3-12-months", "ambition": "moderate", "equity_philosophy": "near-equal-vesting",
     "idea_flexibility": "committed", "edge": "network", "decision_style": "debate",
     "hardest_thing": "Passed the most ambitious state clean energy laws in the country.",
...
COMMITMENTS = ["full-time", "full-time-soon", "part-time", "exploring"]
...
RUNWAYS = ["under-3-months", "3-12-months", "12-plus-months", "undisclosed"]
AMBITIONS = ["bootstrap", "moderate", "venture-scale", "undecided"]
EQUITY_PHILOSOPHIES = ["equal", "near-equal-vesting", "contribution-based", "no-strong-view"]
EDGES = ["technical", "domain", "network"]
IDEA_FLEXIBILITIES = ["committed", "flexible", "n/a"]
DECISION_STYLES = ["debate", "write-then-decide", "defer-to-owner", "data-driven"]
        ...
        fillers.append(
            {
                ...
                "equity_philosophy": random.choice(EQUITY_PHILOSOPHIES),
                "idea_flexibility": random.choice(IDEA_FLEXIBILITIES),
                "edge": random.choice(EDGES),
                "decision_style": random.choice(DECISION_STYLES),
                "hardest_thing": f"Shipped a hard {areas[0]} project end to end",
...
def generate_attendees(count: int = 60) -> list[dict]:
    ...
    for person in selected:
        ...
        attendee = {
            ...
            "runway": person.get("runway", "undisclosed"),
            "ambition": person.get("ambition", "undecided"),
            "equity_philosophy": person.get("equity_philosophy", "no-strong-view"),
            "idea_flexibility": person.get("idea_flexibility", "n/a"),
            "edge": person.get("edge", "unknown"),
            "decision_style": person.get("decision_style", "unknown"),
            "proof_summary_1": person.get("proof_summary_1", ""),
            "proof_summary_2": person.get("proof_summary_2", ""),
            "hardest_thing": person.get("hardest_thing", ""),
...
def generate_matrix(attendees: list[dict]) -> dict[str, dict]:
    ...
    for a, b in combinations(attendees, 2):
        ...
        # Commitment alignment — large tier gaps predict breakups
        commitment_gap = abs(
            COMMITMENT_TIER[Commitment(a["commitment"])]
            - COMMITMENT_TIER[Commitment(b["commitment"])]
        )
        if commitment_gap == 3:
            base -= 25
        elif commitment_gap == 2:
            base -= 10
        elif commitment_gap == 0:
            base += 8

        # Ambition alignment — bootstrap vs venture-scale is a hard mismatch
        if {a["ambition"], b["ambition"]} == {"bootstrap", "venture-scale"}:
            base -= 15
        elif a["ambition"] == b["ambition"] and a["ambition"] != "undecided":
            base += 8

        # Equity philosophy clash
        if {a["equity_philosophy"], b["equity_philosophy"]} == {"equal", "contribution-based"}:
            base -= 10

        # Complementary edges within a shared climate area
        if a["edge"] != b["edge"] and overlap >= 1:
            base += 8
